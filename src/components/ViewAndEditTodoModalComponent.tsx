...
const ViewAndEditTodoModalComponent: React.FC<
          ...
          {props.editMode ? (
            <View style={styles.modalDetailContent}>
              <TextInput
                ...
                value={props.selectedData?.item.priority}
                onChangeText={(text) => {
                  const tempData: todos = {
                    ...
                    dueDate: props.selectedData?.item.dueDate,
                    dueTime: props.selectedData?.item.dueTime,
                    priority: text,
                  };
                  props.setSelectedData({ item: tempData, itemType: "todo" });
                }}
              />
              <TextInput
                placeholder="Title"
                ...
                onChangeText={(text) => {
                  const tempData: todos = {
                    ...
                    dueDate: props.selectedData?.item.dueDate,
                    dueTime: props.selectedData?.item.dueTime,
                    priority: props.selectedData?.item.priority,
                  };
                  props.setSelectedData({ item: tempData, itemType: "todo" });
                }}
              />
              ...
              <TextInput
                ...
                placeholderTextColor="black"
                style={styles.textInput}
                value={props.selectedData?.item.dueDate}
                onChangeText={(text) => {
                  const tempData: todos = {
                    id: props.selectedData?.item.id,
                    title: props.selectedData?.item.title,
              ...
              <TextInput
                ...
                placeholderTextColor="black"
                style={styles.textInput}
                value={props.selectedData?.item.dueTime}
                onChangeText={(text) => {
                  const tempData: todos = {
                    id: props.selectedData?.item.id,
                    title: props.selectedData?.item.title,
...
export default ViewAndEditTodoModalComponent;
